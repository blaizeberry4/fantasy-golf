...
alter table pga_tour_tournament_picks_stroke_play
    drop constraint pga_tour_tournament_picks_stroke_play_pkey,
    add primary key (tournament_id, user_id, pick_index),
    drop column id
;
...
alter table pga_tour_tournament_fields_stroke_play owner to postgres;
grant all on table pga_tour_tournament_fields_stroke_play to postgres;
grant select on table pga_tour_tournament_fields_stroke_play to authenticated;